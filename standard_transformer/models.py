...
__all__ = ['top_p_filter', 'top_k_filter', 'sampler', 'get_axial_dims', 'TransformerLM', 'TransformerEncDec']
...
class TransformerLM(nn.Module):
    ...
    """
    def __init__(self, vocab_sz, dim, n_layers=6, heads=8, causal=True,
...
class TransformerEncDec(nn.Module):
    ...
    """
    def __init__(self, enc_vocab_sz, dec_vocab_sz, dim, n_layers=6, heads=8,
        ...
        self.enc_emb = TransformerEmbedding(enc_vocab_sz, dim, max_seq_len, dropout=enc_emb_dropout, pos_enc=pos_enc,
                                            axial_shape=axial_shape, axial_emb_dims=axial_emb_dims)
        ...
        if shared_emb:
            ...
            self.dec_emb = TransformerEmbedding(dec_vocab_sz, dim, max_seq_len, dropout=dec_emb_dropout, pos_enc=pos_enc,
                                                axial_shape=axial_shape, axial_emb_dims=axial_emb_dims)
        self.encoder = TransformerEncoder(dim, enc_n_layers, heads, d_ff=d_ff, attn_dropout=attn_dropout, ff_dropout=ff_dropout,
                                          prenorm=prenorm, attn_bias=attn_bias, final_norm=nn.LayerNorm)
        self.decoder = TransformerDecoder(dim, dec_n_layers, heads, d_ff=d_ff, attn_dropout=attn_dropout, ff_dropout=ff_dropout,
